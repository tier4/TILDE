...
class TestMessageTrackingTags(unittest.TestCase):

    def test_erase_until(self):
        infos = MessageTrackingTags()
        infos.add(MessageTrackingTag(
            'topic1',
            time_msg(8, 0),
            time_msg(9, 0),
            True,
        ...
        self.assertEqual(len(infos.topic_vs_message_tracking_tags.keys()), 2)
        self.assertEqual(len(infos.topic_vs_message_tracking_tags['topic1'].keys()), 2)
        self.assertEqual(len(infos.topic_vs_message_tracking_tags['topic2'].keys()), 1)
        ...
        self.assertEqual(len(infos.topic_vs_message_tracking_tags['topic1'].keys()), 1)
        self.assertTrue('30.000000000' in
                        infos.topic_vs_message_tracking_tags['topic1'].keys())
        self.assertEqual(len(infos.topic_vs_message_tracking_tags['topic2'].keys()), 1)
        ...
        self.assertTrue('30.000000000' in
                        infos.topic_vs_message_tracking_tags['topic1'].keys())
        self.assertEqual(len(infos.topic_vs_message_tracking_tags['topic2']), 0)
    ...
    def test_erase_until_many(self):
        ...
        self.assertEqual(len(infos.topic_vs_message_tracking_tags['topic1'].keys()), 6)
