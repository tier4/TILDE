...
A custom version of [ament_lint_common](https://github.com/ament/ament_lint/tree/master/ament_lint_common) for [CARET](https://github.com/tier4/caret).

## Usage

Add dependencies of `ament_lint_auto` and `caret_lint_common` to your package as below.
