...
private:
  ...
  std::vector<SteeSubscription<PointCloud2>::SharedPtr> input_stee_subscriptions_;

  // subscription + publisher for republish
  rclcpp::Subscription<PointCloud2>::SharedPtr output_subscription_;
  SteePublisher<PointCloud2>::SharedPtr output_republisher_;
...
RCLCPP_COMPONENTS_REGISTER_NODE(tilde::SteeRepublisherNodeMap)
